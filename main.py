...
API_ID = int(os.getenv("TG_API_ID", "2284342"))
API_HASH = os.getenv("TG_API_HASH", "c33e4ed013a31c92f410ce67ce055237")
BOT_TOKEN = os.getenv("BOT_TOKEN", "6373207930:AAHAf4ZgwC-UuyOfNGCjOu2kfqmWDWOS5wI")
MONGODB_URL = os.getenv("MONGODB_URL", "mongodb+srv://noob:noob@cluster0.tpbot.mongodb.net/?retryWrites=true&w=majority")
BOT_USERNAME = None
